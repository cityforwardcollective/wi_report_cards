---
title: Wisconsin School Report Cards
format: 
  html:
    echo: false
    message: false
...
full_table |> 
  ...
  mutate(
    ...
    "Report Card Link" = case_when(
      rc_n == "both" ~ glue(
    "<a href='{base}/{district}/{school_name} All Students School Report Card {school_year}.pdf' target='_blank'>All Students</a><br>",
    "<a href='{base}/{district}/{school_name} Choice Students School Report Card {school_year}.pdf'",
